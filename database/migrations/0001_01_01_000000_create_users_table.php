...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->boolean('smokeAlcohol');
            $table->text('allergies')->nullable();
            $table->text('substanceAbuse')->nullable();
            $table->text('healthConditions')->nullable();
            $table->boolean('consentToDonate');
            $table->boolean('privacyPolicy');
